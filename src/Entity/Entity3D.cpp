...
Entity3D::Entity3D(Renderer* renderer, Vec3 position,Vec3 rotation, Vec3 newScale ,bool shouldBeTurnOffByBSP): Entity(
...
Entity3D::Entity3D(Renderer* renderer, Vec3 position, Vec3 newScale,bool shouldBeTurnOffByBSP): Entity(
